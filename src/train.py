...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--render-every", type=int, default=8,
                   help="update the HUD every N vec steps")
...
def main() -> None:
    ...
    callbacks = CallbackList([
        ...
        GhostRenderCallback(ghost, args.num_envs, render_every=args.render_every,
